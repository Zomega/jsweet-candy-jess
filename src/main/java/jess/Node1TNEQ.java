...
class Node1TNEQ extends Node1 {
  Node1TNEQ(int paramInt1, int paramInt2, int paramInt3, int paramInt4, Value paramValue, Rete paramRete) {
    super(5, paramInt1, paramInt2, paramInt3, paramInt4, paramValue, paramRete);
  }
