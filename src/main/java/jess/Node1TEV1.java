...
class Node1TEV1 extends Node1 {
  Node1TEV1(int paramInt1, int paramInt2, int paramInt3, int paramInt4, Value paramValue, Rete paramRete) {
    super(3, paramInt1, paramInt2, paramInt3, paramInt4, paramValue, paramRete);
  }
